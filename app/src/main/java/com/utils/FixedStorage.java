...
public class FixedStorage {
	...
	public static final int ADD_CHAR   		= 0x00;  // Add    Character
	public static final int REM_CHAR   		= 0x01;  // Remove Character
	...
	public static final String[] LIST_ITMES_DEJAVOO = {"Credit","Debit"};
}
