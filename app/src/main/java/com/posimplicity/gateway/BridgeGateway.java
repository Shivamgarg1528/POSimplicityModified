...
public class BridgeGateway extends BaseGateway {
    ...
    protected void sendPayment(CardInfoModel pCardInfoModel) {
        ...
        queryMap.put("ExpDate", pCardInfoModel.getCardExpMonth().concat(pCardInfoModel.getCardExpYear()));
    ...
    protected void sendResultBack(CardInfoModel pCardInfoModel) {
        ...
        pCardInfoModel.getEventListener().onEvent(BaseGateway.TRANSACTION_BRIDGE_KEYED, isSuccess);
    }
}
