...
public class Custom1Fragment extends BaseFragment implements OnClickListener {

	private TextView checkedAmountTextview;
	private float custom1Amt = 0.0f;
	...
	public void onCustom1AmountUpdate()
	{
		custom1Amt  = Variables.totalBillAmount - Variables.cashAmount-Variables.giftAmount - Variables.ccAmount - Variables.rewardsAmount;		
		String value = MyStringFormat.formatWith2DecimalPlaces(custom1Amt);
	...
	public void onActivityCreated(Bundle savedInstanceState) {		
		...
		checkBtn.setText(MaintFragmentTender1.getCustom1Name(mContext));
		onCustom1AmountUpdate();
	...
	private void doPayment() {
		...
		if(!localInsatnceOfHome.isShopingCartEmpty()) {
			Variables.custom1Amount = custom1Amt;
	...
	public void onClick(View v) {
		...
		case R.id.check_split:
			...
			new ShowSplitPopUpOnConditions(mContext,width,height,custom1Amt,PAYMENT_MODE,ORDER_STATUS).letShow();
			break;
